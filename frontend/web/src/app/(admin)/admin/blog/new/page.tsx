...
export default function AdminNewBlogPage() {
  ...
  const { mutateAsync: createPost, isPending } = useCreateBlogPost();
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold tracking-tight">Thêm Bài viết mới</h1>
          <p className="text-muted-foreground mt-1">Xuất bản nội dung và tin tức mới</p>
        </div>
      </div>
